...
The add-on Dockerfile now uses the Home Assistant base images and is built with
`home-assistant/builder`. See [docs/devcontainer.md](docs/devcontainer.md) for
more information.
